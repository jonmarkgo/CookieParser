    ...
    concepts: [
      {
        ...
        bg: "indigo",
        text: "Every ingredient is expressed as a percentage of total flour weight. Flour is always 100%. This lets you compare recipes regardless of batch size. A standard cookie might be 60-80% fat and 80-120% sugar relative to flour.",
        source: { label: "King Arthur Baking", url: "https://www.kingarthurbaking.com/pro/reference/bakers-percentage" },
      },
      {
        title: "Tenderizers vs Tougheners",
        bg: "amber",
        text: "<strong>Tenderizers</strong> (fats, sugars, egg yolks) weaken gluten structure, making baked goods softer and more crumbly. <strong>Tougheners</strong> (flour, egg whites) build structure through gluten and protein networks. The ratio between them determines if your cookie is cakey, chewy, or crisp.",
        source: { label: "Shirley Corriher, BakeWise (2008)", url: "https://www.seriouseats.com/cookie-science" },
      },
      {
        title: "Hydration",
        bg: "emerald",
        text: "The ratio of liquids (water, milk, eggs) to flour. Higher hydration means more steam, more gluten development, and chewier texture. In cookies, hydration typically ranges from 10-30%.",
        source: { label: "King Arthur Baking", url: "https://www.kingarthurbaking.com/blog/2019/07/12/hydration-and-baking" },
      },
      {
        title: "Ruhlman Ratios",
        bg: "rose",
        text: "Michael Ruhlman's framework reduces recipes to simple ratios. A basic cookie is <strong>3:2:1</strong> (flour:fat:sugar). Deviations reveal the recipe's intent: more fat = richer, more sugar = crispier edges, more egg = cakier.",
        source: { label: "Michael Ruhlman, Ratio (2009)", url: null },
      },
    ],
    ...
    concepts: [
      {
        title: "Baker's Percentages",
        bg: "indigo",
        text: "Every ingredient is expressed as a percentage of total flour weight. Flour is always 100%. This lets you compare cakes regardless of batch size. A typical butter cake has 80-100% sugar and 50-100% fat relative to flour.",
        source: { label: "King Arthur Baking", url: "https://www.kingarthurbaking.com/pro/reference/bakers-percentage" },
      },
      {
        title: "Tenderizers vs Tougheners",
        bg: "amber",
        text: "<strong>Tenderizers</strong> (fats, sugars, egg yolks) create a softer, more delicate crumb. <strong>Tougheners</strong> (flour, egg whites) build the cake's structure. Too much toughener makes cake rubbery; too much tenderizer and it won't hold together.",
        source: { label: "Shirley Corriher, BakeWise (2008)", url: "https://www.seriouseats.com/food-lab-best-chocolate-cake" },
      },
      {
        title: "Creaming Method",
        bg: "emerald",
        text: "Beating butter and sugar together incorporates air, creating a lighter crumb. The ratio of fat to sugar affects how much air the batter can hold and how the cake rises.",
        source: { label: "King Arthur Baking", url: "https://www.kingarthurbaking.com/blog/2017/05/22/creaming-butter-and-sugar" },
      },
      {
        title: "Pound Cake Ratio",
        bg: "rose",
        text: "The classic pound cake is <strong>1:1:1:1</strong> (flour:butter:sugar:eggs by weight). Modern recipes deviate to achieve different textures: more eggs for springiness, more sugar for tenderness, less butter for lighter crumb.",
        source: { label: "Michael Ruhlman, Ratio (2009)", url: null },
      },
    ],
    aiPromptFragment: `Reference these concepts where relevant:
    ...
    concepts: [
      {
        title: "Baker's Percentages",
        bg: "indigo",
        text: "The standard language of bread baking. Every ingredient as a percentage of total flour weight. Flour is always 100%. Hydration is the most important ratio in bread — lean breads range from 55-70%, while ciabatta can reach 80%+.",
        source: { label: "King Arthur Baking", url: "https://www.kingarthurbaking.com/pro/reference/bakers-percentage" },
      },
      {
        title: "Hydration & Crumb",
        bg: "amber",
        text: "Water content controls the bread's crumb structure. Higher hydration creates larger, more irregular holes (open crumb). Lower hydration produces a tighter, more uniform crumb. Hydration also affects gluten development and dough handling.",
        source: { label: "The Fresh Loaf", url: "https://www.thefreshloaf.com/node/10356/hydration" },
      },
      {
        title: "Lean vs. Enriched",
        bg: "emerald",
        text: "Lean doughs (flour, water, salt, yeast) produce crusty breads with chewy crumb. Enriched doughs add fat, sugar, and eggs — yielding softer, tender breads like brioche and challah. Fat coats gluten strands, producing a finer crumb.",
        source: { label: "Serious Eats", url: "https://www.seriouseats.com/bread-baking-basics" },
      },
      {
        title: "Gluten Development",
        bg: "rose",
        text: "Flour + water + mixing = gluten network. This network traps gas from fermentation, giving bread its rise and structure. More kneading or higher hydration both increase gluten development. Fat and sugar slow gluten formation.",
        source: { label: "King Arthur Baking", url: "https://www.kingarthurbaking.com/blog/2017/06/19/understanding-gluten" },
      },
    ],
    aiPromptFragment: `Reference these concepts where relevant:
    ...
    concepts: [
      {
        title: "Baker's Percentages",
        bg: "indigo",
        text: "Every ingredient as a percentage of total flour weight. Muffins typically have 25-50% fat and 40-60% sugar relative to flour. Higher ratios push muffins toward cake territory.",
        source: { label: "King Arthur Baking", url: "https://www.kingarthurbaking.com/pro/reference/bakers-percentage" },
      },
      {
        title: "The Muffin Method",
        bg: "amber",
        text: "Dry ingredients mixed separately from wet, then combined with minimal stirring. Overmixing develops gluten, producing tough, tunneled muffins. A few lumps in the batter are desirable.",
        source: { label: "Serious Eats", url: "https://www.seriouseats.com/muffin-science" },
      },
      {
        title: "Muffin vs. Cupcake",
        bg: "emerald",
        text: "Muffins use the muffin method (quick mix) with less fat/sugar. Cupcakes use the creaming method with more fat/sugar. The fat:flour ratio is often the clearest indicator — above 50% leans cupcake.",
        source: { label: "King Arthur Baking", url: "https://www.kingarthurbaking.com/blog/2019/08/05/muffins-vs-cupcakes" },
      },
      {
        title: "Dome Height",
        bg: "rose",
        text: "A good muffin dome comes from high initial oven heat and adequate leavening. Higher hydration and proper gluten development help the batter rise before the crust sets.",
        source: { label: "Stella Parks, BraveTart", url: null },
      },
    ],
    aiPromptFragment: `Reference these concepts where relevant:
    ...
    concepts: [
      {
        title: "Baker's Percentages",
        bg: "indigo",
        text: "Every ingredient as a percentage of total flour weight. Pie dough is all about the fat:flour ratio — 60-70% fat produces a flaky crust, while lower ratios yield a sturdier, mealy texture.",
        source: { label: "King Arthur Baking", url: "https://www.kingarthurbaking.com/pro/reference/bakers-percentage" },
      },
      {
        title: "Flaky vs. Mealy",
        bg: "amber",
        text: "<strong>Flaky</strong> crust has larger fat pieces that create steam pockets. <strong>Mealy</strong> crust has fat rubbed in finely, producing a crumbly, cookie-like texture. The size of fat pieces matters more than the amount.",
        source: { label: "Stella Parks, BraveTart (2017)", url: "https://www.seriouseats.com/old-fashioned-flaky-pie-dough-recipe" },
      },
      {
        title: "Water & Gluten",
        bg: "emerald",
        text: "Water activates gluten — more water means more gluten, tougher crust. Fat coats flour to block water absorption. The goal is just enough water to hold the dough together without making it tough.",
        source: { label: "Serious Eats", url: "https://www.seriouseats.com/science-of-pie-dough" },
      },
      {
        title: "Fat Temperature",
        bg: "rose",
        text: "Cold fat is essential for flaky pie crust. As cold fat melts in the oven, it creates steam pockets between flour layers. Warm fat blends into the flour, yielding a mealy (but still tender) texture.",
        source: { label: "King Arthur Baking", url: "https://www.kingarthurbaking.com/blog/2015/11/23/pie-crust-103-how-fat-affects-crust" },
      },
    ],
    aiPromptFragment: `Reference these concepts where relevant:
    ...
    concepts: [
      {
        title: "Baker's Percentages",
        bg: "indigo",
        text: "Every ingredient as a percentage of total flour weight. Brownies use far more fat and sugar than most baked goods — fudgy brownies can have 100%+ fat and 150%+ sugar relative to flour.",
        source: { label: "King Arthur Baking", url: "https://www.kingarthurbaking.com/pro/reference/bakers-percentage" },
      },
      {
        title: "Fudgy vs. Cakey",
        bg: "amber",
        text: "The fat:flour ratio is the primary indicator. High fat (>80%) = fudgy and dense. More egg and flour push brownies cakey. The classic debate is really about where you land on this ratio spectrum.",
        source: { label: "Serious Eats", url: "https://www.seriouseats.com/food-lab-best-brownies" },
      },
      {
        title: "Sugar & Shine",
        bg: "emerald",
        text: "High sugar content dissolves during baking and forms a thin, crackly, shiny crust on top as it cools. This signature brownie top requires sufficient sugar and proper mixing to dissolve it into the batter.",
        source: { label: "Handle the Heat", url: "https://handletheheat.com/brownie-science/" },
      },
      {
        title: "Chocolate vs. Cocoa",
        bg: "rose",
        text: "Bar chocolate adds fat (cocoa butter), pushing toward fudgy. Cocoa powder adds flavor without extra fat, leaning cakey. Many recipes use both for flavor depth and texture balance.",
        source: { label: "Stella Parks, BraveTart (2017)", url: null },
      },
    ],
    aiPromptFragment: `Reference these concepts where relevant:
    ...
    concepts: [
      {
        title: "Baker's Percentages",
        bg: "indigo",
        text: "Every ingredient as a percentage of total flour weight. Pastries vary wildly — scones might have 40% fat, while croissant dough can exceed 60% from the butter block alone.",
        source: { label: "King Arthur Baking", url: "https://www.kingarthurbaking.com/pro/reference/bakers-percentage" },
      },
      {
        title: "Lamination",
        bg: "amber",
        text: "Laminated pastries (croissants, puff pastry) fold butter between dough layers. Each fold multiplies the layers exponentially. The butter melts during baking, creating steam that separates the layers into flaky sheets.",
        source: { label: "Serious Eats", url: "https://www.seriouseats.com/croissant-science" },
      },
      {
        title: "Fat Temperature",
        bg: "emerald",
        text: "Cold butter creates distinct layers (flaky). Room-temp butter blends into dough (tender but not flaky). For scones and biscuits, cold fat is rubbed in to pea-size pieces for a combination of tender and flaky.",
        source: { label: "King Arthur Baking", url: "https://www.kingarthurbaking.com/blog/2015/11/23/pie-crust-103-how-fat-affects-crust" },
      },
      {
        title: "Choux Principle",
        bg: "rose",
        text: "Choux pastry cooks the flour in liquid and fat before adding eggs. This pre-gelatinizes the starch, and the high egg content creates steam for dramatic puffing. The result is a crisp, hollow shell.",
        source: { label: "Stella Parks, BraveTart (2017)", url: null },
      },
    ],
    aiPromptFragment: `Reference these concepts where relevant:
    ...
    concepts: [
      {
        title: "Baker's Percentages",
        bg: "indigo",
        text: "Every ingredient is expressed as a percentage of total flour weight. Flour is always 100%. This universal system lets you compare recipes regardless of batch size or measurement system.",
        source: { label: "King Arthur Baking", url: "https://www.kingarthurbaking.com/pro/reference/bakers-percentage" },
      },
      {
        title: "Tenderizers vs Tougheners",
        bg: "amber",
        text: "<strong>Tenderizers</strong> (fats, sugars, egg yolks) weaken gluten structure for softer results. <strong>Tougheners</strong> (flour, egg whites) build structure. The balance between them controls texture.",
        source: { label: "Shirley Corriher, BakeWise (2008)", url: "https://www.seriouseats.com/cookie-science" },
      },
      {
        title: "Hydration",
        bg: "emerald",
        text: "The ratio of liquids to flour. Water activates gluten and creates steam. Different baked goods need different hydration levels for optimal texture.",
        source: { label: "King Arthur Baking", url: "https://www.kingarthurbaking.com/blog/2019/07/12/hydration-and-baking" },
      },
      {
        title: "Fat & Gluten",
        bg: "rose",
        text: "Fat coats flour proteins, limiting their contact with water and reducing gluten formation. More fat generally means more tender, less chewy results. The type and temperature of fat also matter.",
        source: { label: "Harold McGee, On Food and Cooking", url: null },
      },
    ],
    aiPromptFragment: `Reference these concepts where relevant:
- Tenderizer/toughener balance (from Shirley Corriher's BakeWise)
